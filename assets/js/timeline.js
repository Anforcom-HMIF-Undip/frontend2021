...
showTimeline(cardSeminar,timelineUI,"Pembukaan Pendaftaran");
  ...
  function showTimeline(card,timeline,description){
    ...
    for (let i = 0; i<timeline.length;i++) {
        if (timeline[i].description == description){
            html +=
            `<div class="card-timeline active d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center px-3 px-lg-4 py-4 my-3">
            ...
            html +=
            `<div class="card-timeline d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center px-3 px-lg-4 py-4 my-3 ">
                <div class="date mb-3 mb-lg-0">
                    <h3 class="day m-lg-0 fs-2">${timeline[i].day}</h3>
                    <p class="fs-5 month">${timeline[i].month}</p>
                </div>
